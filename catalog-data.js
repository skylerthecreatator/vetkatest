...
const giftWorks = [
    ...
    {
        image: 'images/catalog/gifts/gift-21-vase-ceramic-handles-2500.jpg',
        title: 'Ваза керамическая с ручками',
        description: 'Мягкая керамическая форма для спокойных букетов, сухоцветов и интерьерных веток.',
        price: '2 500 ₽',
        action: 'Хочу этот вариант',
        group: 'Вазы',
    },
    {
        image: 'images/catalog/gifts/gift-22-kashpo-kenzan-stone-1590.jpg',
        title: 'Кашпо для кензана каменное',
        description: 'Низкое фактурное кашпо для кензана и лаконичных настольных композиций.',
        price: '1 590 ₽',
        action: 'Хочу этот вариант',
        group: 'Кашпо и основы',
    },
    {
        image: 'images/catalog/gifts/gift-23-vase-amber-ribbed-2350.jpg',
        title: 'Ваза янтарная рельефная',
        description: 'Тёплая рельефная ваза для выразительного букета и мягкого интерьерного света.',
        price: '2 350 ₽',
        action: 'Хочу этот вариант',
        group: 'Вазы',
    },
    {
        image: 'images/catalog/gifts/gift-24-vase-amber-small-1850.jpg',
        title: 'Ваза янтарная компактная',
        description: 'Компактная стеклянная ваза с тёплым оттенком для небольших букетов.',
        price: '1 850 ₽',
        action: 'Хочу этот вариант',
        group: 'Вазы',
    },
    {
        image: 'images/catalog/gifts/gift-25-vase-blue-large-6700.jpg',
        title: 'Ваза синяя фактурная',
        description: 'Крупная фактурная ваза глубокого синего оттенка для сильного интерьерного акцента.',
        price: '6 700 ₽',
        action: 'Хочу этот вариант',
        group: 'Вазы',
    },
    {
        image: 'images/catalog/gifts/gift-26-vase-smoke-square-2300.jpg',
        title: 'Ваза дымчатая квадратная',
        description: 'Стеклянная ваза с мягкой фактурой и спокойным дымчатым оттенком.',
        price: '2 300 ₽',
        action: 'Хочу этот вариант',
        group: 'Вазы',
    },
    {
        image: 'images/catalog/gifts/gift-27-kashpo-kenzan-black.jpg',
        title: 'Кашпо для кензана чёрное',
        description: 'Глянцевое чёрное кашпо для минималистичных композиций и графичных цветочных работ.',
        action: 'Хочу этот вариант',
        group: 'Кашпо и основы',
    },
    {
        image: 'images/catalog/gifts/gift-28-sheep-plush-950.jpg',
        title: 'Овечка плюшевая',
        description: 'Мягкая овечка как нежное дополнение к букету или отдельный маленький подарок.',
        price: '950 ₽',
        action: 'Хочу этот вариант',
        group: 'Плюшевые подарки',
    },
    {
        image: 'images/catalog/gifts/gift-29-vase-clear-tall-700.jpg',
        title: 'Ваза прозрачная высокая',
        description: 'Простая прозрачная ваза для повседневных букетов и лёгких сезонных цветов.',
        price: '700 ₽',
        action: 'Хочу этот вариант',
        group: 'Вазы',
    },
